...
class AppConfig {
    ...
    // static $SERVER_NAME = "http://easytreino.com";
    static $SERVER_NAME = "https://igreja.echo.com:4430";
    static $AUDIENCE_NAME = "EasyTreino Users";
    static $SECRET_KEY = "!U)oO+{0 +FF>]O5WI]<U~SawkGaZ.,|";

    static $URL_BASE = "igreja.echo.com:8088";//"easytreino.com" ou "easytreino.com/wmteste"
    ...
    static $ADMIN_ID = '56318201aa5a717c29e2363f';
